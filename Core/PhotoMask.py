...
def MakePhotoMask(stream):
    ...
    if (landmark[12].y > landmark[24].y and landmark[24].y > landmark[26].y and landmark[26].y > landmark[28].y and # left side vertical
        landmark[11].y > landmark[23].y and landmark[23].y > landmark[25].y and landmark[25].y > landmark[27].y and # right side vertical
        landmark[12].x < middle and landmark[24].x < middle and landmark[26].x < middle and landmark[28].x < middle and # left side horizontal
        landmark[11].x > middle and landmark[23].x > middle and landmark[25].x > middle and landmark[27].x > middle and # right side horizontal
        landmark[8].x > landmark[12].x and landmark[8].y > landmark[12].y and landmark[8].x < landmark[7].x and landmark[7].x < landmark[11].x and landmark[7].y > landmark[11].y and # head
    ...
    if (pose_validated):
        ...
        bottom_border = min(max([landmark[27].y, landmark[28].y, landmark[29].y, landmark[30].y, landmark[31].y, landmark[32].y]) + cutting_coef, 1)
    ...
    final_stream = Image.fromarray(result)
